    ...
    <v-row justify="center">
      <v-col cols="11">
        <v-row justify="space-between">
          <v-col cols="6">
            <div class="title mb-4 pt-2">シリーズデッキ一覧</div>
          </v-col>
        </v-row>
      </v-col>
    </v-row>
    ...
    >
      <v-row class="py-4 px-6">
        ...
        <v-col cols="12">
          <v-btn
            :to="{
              name: 'series_decks-id-adminConfig',
        ...
        <v-col cols="12">
          ...
          <series-deck-playlist-previewer :deck="selectedDeck" />
        </v-col>
      </v-row>
    </v-navigation-drawer>
...
import SeriesDeckPlaylistPreviewer from '~/components/seriesDecks/SeriesDeckPlaylistPreviewer.vue'
...
export default Vue.extend({
  name: 'SeriesDeckIndexPage',
  components: {
    SimpleDeckItem,
    SeriesDeckPlaylistPreviewer,
    DeckApiStateBadge,
  },

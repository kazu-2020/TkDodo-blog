  ...
  data(): DataType {
    return {
      playlist: {
        ...
        items: [],
        deliverItemListToApi: true,
        deliverEpisodeToApi: true,
      },
  ...
  methods: {
    ...
    save() {
      const body: { [key: string]: string | undefined | boolean } = {
        ...
        deliver_item_list_to_api: this.playlist.deliverItemListToApi,
        deliver_episode_to_api: this.playlist.deliverEpisodeToApi,
        deliver_article_to_api: this.playlist.deliverArticleToApi,
        deliver_how_to_to_api: this.playlist.deliverHowToToApi,
        deliver_event_to_api: this.playlist.deliverEventToApi,
        deliver_faq_page_to_api: this.playlist.deliverFaqPageToApi,

...
} as ComponentMeta<typeof NewPlaylist>

export const Default: ComponentStoryObj<typeof NewPlaylist> = {
  render: () => (
...
export const EditSeriesPlaylist: ComponentStoryObj<typeof NewPlaylist> = {
  ...Default,
  name: 'プレイリスト編成',
...
export const EditDeck: ComponentStoryObj<typeof NewPlaylist> = {
  ...Default,
  name: 'メタ情報編集',
  // eslint-disable-next-line max-statements
  play: async ({ canvasElement }: StoryContext<ReactFramework, unknown>) => {
...
export const SaveDeck: ComponentStoryObj<typeof NewPlaylist> = {
  ...Default,
  name: '保存',
  // eslint-disable-next-line max-statements

Playlist.create!(
  ...
  api_state: 'open',
  alias_id: 'ALIAS-ID-1',
  logo_image: File.open(Rails.root.join('db', 'images', 'sample.jpg')),
  eyecatch_image: File.open(Rails.root.join('db', 'images', 'sample.jpg')),
  hero_image: File.open(Rails.root.join('db', 'images', 'sample.jpg'))
)

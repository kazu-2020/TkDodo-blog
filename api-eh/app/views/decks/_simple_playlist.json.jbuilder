...
if playlist.logo_image_url
  json.logo do
    json.medium do
      json.url playlist.logo_image.storage_key == :store ? playlist.logo_image_url : TMP_LOGO_IMG_UPLOADING
...
if playlist.eyecatch_image_url
  json.eyecatch do
    json.medium do
      json.url playlist.eyecatch_image.storage_key == :store ? playlist.eyecatch_image_url : TMP_EYECATCH_IMG_UPLOADING
...
if playlist.hero_image_url
  json.hero do
    json.medium do
      json.url playlist.hero_image.storage_key == :store ? playlist.hero_image_url : TMP_HERO_IMG_UPLOADING

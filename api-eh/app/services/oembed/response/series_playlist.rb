...
class Oembed::Response::SeriesPlaylist
  ...
  def response
    ...
    src = "#{src_host}/embed/#{extract_series_playlist_url}?layout_pattern=#{layout_pattern}"
  ...
  def extract_series_playlist_url
    url[%r{https?://dev-www-eh.nr.nhk.jp/p/(pl/ts-[A-Z0-9]{10})}, 1]
  end

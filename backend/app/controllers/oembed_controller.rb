...
class OembedController < ApplicationController
  ...
  def dummy_response
...

    {
      ...
      url: "https://www.nhk.jp/p/ts/#{series_id}/",
      title: "TVSeries##{series_id} - episode",
      thumbnail_width: 640,
      thumbnail_height: 360,
      thumbnail_url: "http://placehold.jp/640x360.png",
      html: "<iframe width='100%' height='231' src='https://dev-embed.nr.nhk.jp/p/ts/#{series_id}/' frameborder='0'></iframe>"
    }
  end
end

...
environment_variables(
  JETS_ENV: 'ssm:/aw-editorialhands/production/jets-env',
  DATABASE_URL: 'ssm:/aw-editorialhands/production/database-url',
  AWS_DEFAULT_REGION: 'ap-northeast-1',
  IMAGE_REPO_NAME: 'aw-editorialhands',
  IMAGE_TAG: 'latest',
  AWS_ACCOUNT_ID: 'ssm:/aw-editorialhands/aws-account-id',
  SLACK_WEBHOOK_URL: 'ssm:/aw-editorialhands/slack-webhook-url'
)
